...
import camero from '../assets/camero.jpg';
import keybord from '../assets/keybord.jpg';
import hadfhon from '../assets/hadfhon.jpg';
      ...
      <div className="mt-5 flex justify-center items-center">
        <div className="grid gap-2 grid-cols-6 p-4 py-2 border-2 border-gray-300 bg-gray-50 rounded-lg ">
          {logo.map((logo, index) => (
            <div
              key={index}
              className="flex justify-center items-center p-4 relative border-r border-b border-gray border-collapse"
            >
              <a href="" className="">
      ...
      <div className="p-32 mt-[-60px]">
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="#"
              className="flex flex-col  relative  bg-white border-2 border-blue-400 rounded-lg shadow md:flex-row  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 "
            >
              ...
              <img
                ...
                alt="Xbox"
              />
              <div className=" text-black text-lg flex flex-col opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="flex flex-col text-sm justify-between leading-normal text-gray-500 px-">
                <p className="mt-3 text-sm hover:text-[#0068C8]">Xbox Series</p>
                <p className=" text-lg text-gray-900 dark:text-[#0068C8]">
            ...
            >
              ...
              <div className="flex flex-col text-sm justify-between leading-normal text-gray-500 hover:text-[#0068C8]">
                <p>Samsung Galaxy</p>
                <h5 className="mb-2 text-lg tracking-tight text-gray-900 dark:text-[#0068C8]">
        ...
        <div>
          ...
          <div className="flex gap-12">
            ...
            <div className="w-[300px]">
              <div className="hover:border-1 w-[250px] h-[290px] hover:border-[#0068C8] transition duration-300 rounded-lg flex justify-center items-center">
                <a href="" className="relative">
                  <img src={hadfhon} alt="Laptop" className="h-[100%] w-[100%] rounded-t-md object-cover mx-0" />
                  <p className="absolute top-2 left-2 text-[11px] px-2 bg-[#0068C8] text-white rounded-tr-md rounded-b-md">-15%</p>
                  <p className="absolute top-8 left-2 text-[11px] px-2 bg-red-500 text-white rounded-tr-md rounded-b-md">HOT</p>
                </a>
              </div>
            ...
            <div className="w-[300px]">
              <div className="hover:border-1 w-[250px] h-[290px] hover:border-[#0068C8] transition duration-300 rounded-lg flex justify-center items-center">
                <a href="" className="relative">
                  <img src={keybord} alt="Laptop" className="h-[100%] w-[100%] rounded-t-md object-cover mx-0" />
                  <p className="absolute top-2 left-2 text-[11px] px-2 bg-[#0068C8] text-white rounded-tr-md rounded-b-md">-15%</p>
                  <p className="absolute top-8 left-2 text-[11px] px-2 bg-red-500 text-white rounded-tr-md rounded-b-md">HOT</p>
                </a>
              </div>
            ...
            <div className="w-[300px]">
              <div className="hover:border-1 w-[250px] h-[290px] hover:border-[#0068C8] transition duration-300 rounded-lg flex justify-center items-center">
                <a href="" className="relative">
                  <img src={camero} alt="Laptop" className="h-[100%] w-[100%] rounded-t-md object-cover mx-0" />
                  <p className="absolute top-2 left-2 text-[11px] px-2 bg-[#0068C8] text-white rounded-tr-md rounded-b-md">-15%</p>
                  <p className="absolute top-8 left-2 text-[11px] px-2 bg-red-500 text-white rounded-tr-md rounded-b-md">HOT</p>
                </a>
              </div>
