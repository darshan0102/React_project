  ...
  return (
    <div>
      <div class=" dark:bg-gray-900" id="contact">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 text-center"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
          <div>
            <h1 class="text-4xl font-bold text-black dark:text-gray-100">
              Do yoy have some
              <br />
              questions?
            </h1>
            <p class="max-w-sm mt-4 text-sm text-[#848484] mb-4 dark:text-gray-400">
              We are at your disposal 7 days a week
            </p>
            <p class="text-sm text-[#848484] dark:text-gray-100">
              29 SE 2nd Ave,
              <br />
            ...
            <div class="underline text-sm items-center mt-2 space-x-2 dark:text-gray-400">
              <a href="mailto:Support1234@Ecomall.com" className=" text-[#000]">
                Support1234@Ecomall.com
              </a>
            </div>
            <div class="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
              <a
                href="tel:+08 9229 8228"
                className="text-lg font-semibold text-[#000] hover:underline hover:text-gray-900"
              >
                +08 9229 8228
              </a>
            </div>
            <div className="mb-4 flex items-start gap-4 mt-4">
              <p>
                <a
                  href="#"
                  className="text-gray-900 hover:text-[#0068C8] text-xl"
                >
                  <FiFacebook />
                </a>
              </p>
              ...
              <p>
                <a
                  href="#"
                  className="text-gray-900 hover:text-[#0068C8] text-2xl"
                  >
                  <PiYoutubeLogoThin />
                </a>
              </p>
          ...
          <div>
            <form>
              ...
              <button
                type="submit"
                class="px-10 py-2.5 font-semibold text-white transition-colors bg-gray-900 rounded-md "
              >
                Send Message
              </button>
            </form>
      ...
      <div className="grid grid-cols-1 container mt-12  md:grid-cols-4 mx-42 md:mx-20 gap-4 md:gap-6">
        <div className="">
          ...
          <a
            href="tel:+08 9229 8228"
            className="text-lg font-bold text-[#000000] hover:text-[#000000]"
          >
            +08 9229 8228
          </a>
          <p>
            <a
              href="mailto:Support1234@Ecomall.com"
              className="text-[#000000] hover:text-[#000000] text-sm underline"
            >
              Support1234@Ecomall.com
            </a>
          </p>
        ...
        <div className="">
          ...
          <a
            href="tel:+08 9229 8228"
            className="text-lg font-bold hover:text-[#000000] text-[#000000]"
          >
            (480) 555-0130
          </a>
          <p>
