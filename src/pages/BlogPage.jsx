      ...
      <div className="flex flex-col lg:flex-row mt-10 w-full">
        <div className="w-full h-full lg:w-2/4 lg:ml-24 px-2 lg:px-0">
          <div className="space-y-16">
            <div>
              <img src={blog} className="w-full h-full rounded-lg" />
              ...
              <p className=" text-[12px] text-[#848484] uppercase">
                BY{" "}
                <span className="font-bold text-[#000] hover:underline transition duration-300">
                  Andrew
                </span>{" "}
                FEB 27, 2024
              </p>
              ...
              <blockquote>
                <div className="bg-[#E8F3FE] rounded-lg p-4 mt-2">
                  <p className="text-xl lg:text-3xl text-[#000] font-medium">
                    ...
                    devices, which represents approximately 94% of the
                    population of advanced economies and 83% of emerging
                    economies, according to Pew Research Center{" "}
        ...
        <div className="lg:w-1/4 w-full mt-16 lg:mt-0 lg:ml-10 lg:border-l border-b-1 px-4 lg:px-0 ">
          <div className="lg:ml-7 ml-0">
            <div className="relative inline-block">
              ...
              <a
                href=""
                className="text-[#000] text-2xl absolute right-3 top-1/2 transform -translate-y-1/2"
              >
                <GoSearch />
              </a>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <a href="" className="text-[#000] text-[15px] lg:text-base">
                    What Is a Smartphone? A Mobile Phone and Computer In One
                    Device
                  </a>
                </div>
            ...
            <div className="mt-16">
              ...
              <div className="grid  gap-4 grid-cols-2">
                <div className="">
                  <p className="border-1 border-[#848484] text-[#848484] hover:border-[#0068C8] hover:text-[#0068C8] rounded text-sm px-3 py-1">
                    Kids' Electronics
                  </p>
                  <p className="border-1 border-[#848484] text-[#848484] hover:border-[#0068C8] hover:text-[#0068C8] rounded text-sm px-3 py-1">
                    Laptop
