    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="bg-white p-6 md:p-8 shadow-lg rounded-lg">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-black">Login</h2>
          <form>
            <div className="mb-4">
            ...
            <div className="mb-4 relative">
              ...
              <input
                ...
                required
              />
              <a href="#" className="absolute top-3 right-3 text-black">
                <VscEye />
              </a>
            </div>
            <div className="flex items-center mb-4">
              <button
                type="submit"
                className="bg-[#0068C8] text-gray-50 py-2 rounded hover:bg-white hover:border font-semibold px-8 md:px-12 hover:border-[#0068C8] hover:text-[#0068C8] transition duration-300"
              >
                LOG IN
              </button>
